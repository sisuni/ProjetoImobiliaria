...
public class JanelaTaxas extends JFrame implements IViewer{
	private JPanel contentPane;
	private ICtrlManter ctrl;
	private JTable table;
	
	
	public JanelaTaxas(ICtrlManter c){
		this.ctrl = c;
		setTitle("Taxas - Imobiliária");
		...
		btnAlterar.setBounds(110, 232, 89, 23);
		...
		btnExcluir.setBounds(210, 232, 89, 23);
		...
		btnSair.setBounds(310, 232, 89, 23);
		contentPane.add(btnSair);
		/*Fim dos Botões*/
		
		/*Inicio da Table*/
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 11, 390, 212);
