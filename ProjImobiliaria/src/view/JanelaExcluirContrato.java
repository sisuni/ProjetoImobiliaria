...
/**
 * Implementação da janela de confirmação de exclusão do Contrato
 * @author Valdecir
 *
 */
public class JanelaExcluirContrato {
	/**
	 ...
	 * se o usuário deseja ou não excluir o Contrato
	 * @param nome
	 */
	public JanelaExcluirContrato(ICtrlManter ct, Object selecionado){
		// Guardo a referência para o controlador de caso de uso
		this.ctrl = ct;
		// Pergunto ao usuário o que ele deseja fazer
		this.opcao = JOptionPane.showConfirmDialog(null, "Deseja remover o Contrato " + selecionado + "?");
